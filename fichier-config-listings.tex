%% mccommon.sty -- LaTeX2e MC common commands and environments
%
% Copyright (C) 2008-2014 Fabrice Niessen

%* --[ Identification --------------------------------------------------------

\NeedsTeXFormat{LaTeX2e}
\ProvidesPackage{mccommon}[2021/04/07 v1.0 MCit Common stuff between documents and presentations]
...
\lstdefinelanguage{sword}{%
  morekeywords=[1]{ontology, import, as},
  morekeywords=[2]{rule, if, then, and, is, a, function, of},
  morekeywords=[3]{class, with, range},
  sensitive=true,
  otherkeywords={[, ], (, ), \\=,.},
  %
  morestring=[b]",
  ...
  commentstyle=\itshape\color[rgb]{0.938,0,0},
